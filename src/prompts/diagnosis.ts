...
JSON schema:
{
  ...
  "harshEvaluation": "<comprehensive assessment covering BOTH appearance AND profile value — minimum 300 characters. Structure: (1) overall face assessment with specific feature observations, (2) body type assessment, (3) income evaluation with tier (S/A/B/C/D) and explicit comparison to age-group average, (4) height/occupation assessment, (5) overall marriage-app verdict. For scores below 60: be blunt. All in Japanese>",
  "strengths": "<genuine strengths — minimum 3 points, each starting with '・'. Mix appearance AND profile strengths (e.g., income, height). Explain why each is an advantage in marriage-app context. All in Japanese>",
  "weaknesses": "<honest weaknesses — minimum 3 points, each starting with '・'. Mix appearance AND profile weaknesses. For income: state the exact tier, compare to average, and give concrete career/income improvement advice. For scores below 60: do not soften. All in Japanese>",
  "socialImpression": "<marriage-app competitiveness report — cover: (1) appearance tier from photos, (2) income tier with explicit grade and comparison to peers, (3) combined overall tier (上位/中位/下位), (4) what types of partners are realistically attainable given this profile, (5) the single most impactful thing to improve market position. Minimum 250 characters. All in Japanese>",
  "improvementPriority": [
